...
void main() {
    ...
    // Gradient from purple to cyan (cipher-primary to cipher-secondary colors)
    vec3 color1 = vec3(0.322, 0.153, 1.0);  // #5227FF - cipher-primary
    vec3 color2 = vec3(0.0, 0.878, 0.722);  // #00E0B8 - cipher-secondary
    vec3 color = mix(color1, color2, st.x + st.y * 0.5);
